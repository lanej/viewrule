...
Plugin 0.9.1 adds a short task-scoped composition preflight and retrieves guidance
selectively. It continues to pin engine 0.9.0 with opt-in composition checks for alignment, rhythm,
