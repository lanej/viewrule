...
export const designRuleRegistry = Object.freeze([
  ...
  { id: "DR-017", file: "DR-017-alignment.md", enforcement: "automated" },
  { id: "DR-018", file: "DR-018-rhythm.md", enforcement: "automated" },
  { id: "DR-019", file: "DR-019-spatial-economy.md", enforcement: "automated" },
  { id: "DR-020", file: "DR-020-balance.md", enforcement: "automated" },
]);
