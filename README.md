...
**Status:** experimental 0.7.0, distributed through
...
Download `viewrule-0.7.0.tgz` and `SHA256SUMS` from the
...
npm install --global ./viewrule-0.7.0.tgz
