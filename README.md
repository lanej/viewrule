...
**Status:** experimental 0.3.1, distributed through
...
Download `viewrule-0.3.1.tgz` and `SHA256SUMS` from the
[v0.3.1 release](https://github.com/lanej/viewrule/releases/tag/v0.3.1).
From that download directory, verify the checksum and install:

```sh
# Linux; on macOS use: shasum -a 256 -c SHA256SUMS
sha256sum -c SHA256SUMS
npm install --global ./viewrule-0.3.1.tgz
